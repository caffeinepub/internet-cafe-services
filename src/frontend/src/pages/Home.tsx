...
const featuredServices = [
  {
    ...
    description:
      "Apply online for birth certificate registration and corrections with expert assistance.",
    color: "cyan",
  },
  {
    icon: UserCheck,
    ...
    description:
      "Update name, address, mobile number and other Aadhaar details on UIDAI portal.",
    color: "green",
  },
  {
    icon: CreditCard,
    title: "PAN Card",
    description:
      "New PAN card application or corrections via NSDL/UTIITSL with document support.",
    color: "cyan",
  },
  {
    icon: ShoppingBag,
    title: "Ration Card",
    description:
      "Apply for new ration card or update family member details on state portal.",
    color: "green",
  },
  {
    icon: Heart,
    title: "Health Card",
    description:
      "Register for government health schemes and get your health card issued online.",
    color: "cyan",
  },
  {
    icon: Shield,
    title: "Ayushman Card",
    description:
      "PM-JAY Ayushman Bharat card registration for eligible families — quick & easy.",
    color: "green",
  },
];
...
export default function Home() {
  return (
    <>
      <SEOHead
        title="ICC Computer & Online Service – Birth Certificate, Aadhaar, PAN Card & Online Services"
        description="Visit ICC Computer & Online Service for online government document assistance: Birth Certificate, Aadhaar Update, PAN Card, Ration Card, Health Card, Ayushman Card, printing & more. Open 7 days a week in Mahipalpur, Delhi!"
        ogTitle="ICC Computer & Online Service – Your Local Cyber Cafe in Mahipalpur, Delhi"
        ogDescription="ICC Computer & Online Service — online government document services, fast internet, printing & more. Affordable rates, friendly service. Visit us today!"
      />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt="ICC Computer & Online Service interior with glowing screens"
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
          ...
          <p className="text-muted-foreground text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Government document services, high-speed internet, printing & more —
            all under one roof. Birth Certificate, Aadhaar, PAN Card, Ration
            Card, Health Card & Ayushman Card assistance available.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-base leading-relaxed mb-6">
                ICC Computer & Online Service has been serving the local
                community with reliable, affordable, and fast digital services.
                Whether you need to apply for a Birth Certificate, update your
                Aadhaar, get a PAN Card, Ration Card, Health Card, or Ayushman
                Card — we've got you covered.
              </p>
              <p className="text-muted-foreground text-base leading-relaxed mb-8">
                Our modern facility is equipped with the latest computers,
                high-speed fiber internet, and professional printing equipment.
                We pride ourselves on providing a clean, comfortable, and
                welcoming environment for all our customers.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-base max-w-xl mx-auto">
              We help you apply for and update all major government documents
      ...
      <section className="py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-10">
            Visit ICC Computer & Online Service today or get in touch. Our staff
            is ready to assist you with all your online document needs — quickly
            and affordably.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/contact">
