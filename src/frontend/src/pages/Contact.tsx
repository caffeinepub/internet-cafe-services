...
export default function Contact() {
  ...
  return (
    <>
      <SEOHead
        title="ICC Computer & Online Service — Contact Us | Mahipalpur, Delhi"
        description="Contact ICC Computer & Online Service in Mahipalpur, Delhi. Call us at 9650810622 or send a message. We're open Mon–Sat 8AM–10PM and Sunday 9AM–8PM."
        ogTitle="Contact ICC Computer & Online Service — Mahipalpur, Delhi"
        ogDescription="Get in touch with ICC Computer & Online Service. Visit us at Shop, Hotel SKY Blue WALI GALI, Mahipalpur, Delhi or call 9650810622."
      />
      ...
      <section className="pt-28 pb-12 lg:pt-36 lg:pb-16 relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Have a question or need assistance? Reach out to ICC Computer &
            Online Service — we're here to help you with all your digital
            service needs.
          </p>
        </div>
      </section>
                  ...
                  <tbody>
                    {[
                      ...
                      >
                        ...
                        <td className="px-4 py-2 text-foreground font-medium text-right">
                          {row.hours}
                        </td>
                      </tr>
                    ))}
                ...
                <Card className="bg-dark-card border-cyber-green/30">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground text-sm mb-6">
                      Thank you for reaching out to ICC Computer & Online
                      Service. We'll get back to you as soon as possible.
                    </p>
                    <Button
                      variant="outline"
                  ...
                  <CardContent className="p-6">
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="space-y-2">
                        <Label
                          htmlFor="name"
                          className="text-foreground font-heading text-sm"
                        >
                          Your Name
                        </Label>
                        <Input
