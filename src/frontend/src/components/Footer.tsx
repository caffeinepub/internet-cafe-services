          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-4 group">
              <img
                ...
                alt="ICC Computer & Online Service"
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Your trusted neighborhood cyber cafe offering online government
              document services, fast internet, printing, and more — all under
              one roof.
            </p>
            {/* Social Links */}
      ...
      <div className="border-t border-border/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
            <span>
              © {year} ICC Computer & Online Service. All rights reserved.
            </span>
